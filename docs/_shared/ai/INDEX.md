...
**最終更新**: 2026-05-23 17:58
**生成元**: /flow:feature _shared/ai (+ /flow:revise + /flow:tdd 2026-05-23)
**状態**: コア実装完了 (2026-05-23、OpenAI SDK/Upstash/Vercel handler/frontend は app/api bootstrap defer)
...
| 101 | [101_ai_IMPL_REPORT.md](./101_ai_IMPL_REPORT.md) | IMPL_REPORT | コア完了 | 2026-05-23 | prompt/schema/quota/rate-limit/retry 実装、SDK glue defer |
| 102 | [102_ai_UNIT_TEST_REPORT.md](./102_ai_UNIT_TEST_REPORT.md) | UNIT_TEST_REPORT | 完了 | 2026-05-23 | 37 tests / 行 98.94% / 分岐 93.65% |
...
- defer (app/api bootstrap): `api/identify-plant.ts` / `api/_lib/{openai,prompt,schema}.ts` / frontend `identify.ts` / Upstash binding
