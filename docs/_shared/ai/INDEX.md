...
| `fix_001_20260525_guest-trial-quota/` | fix (high) | 001 | 実装完了 (932 green、実機/E2E 待ち) | 実効 quota 層 (effectiveQuota + fetchEffectiveQuota 共用) を新設し匿名 trial(3)/登録月次(10)+credits を identify/billing/frontend に単一配線、匿名超過は link_required(401) | [INDEX](./fix_001_20260525_guest-trial-quota/INDEX.md) |
