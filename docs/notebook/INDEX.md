...
**最終更新**: 2026-05-22 15:35
**生成元**: /flow:feature notebook

<!-- auto-generated-start -->

## 機能概要
ノート閲覧 (タイムライン / カレンダー / 地図 / 図鑑 4 モード) + 詳細編集 + 月次コラージュ + UGC シェア (UC2)。
...
- 実装コード: `src/features/notebook/`, `supabase/functions/og-collage/`
